...
/**
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
var f;m.finalized=!0,m.elementProperties=new Map,m.elementStyles=[],m.shadowRootOptions={mode:"open"},null==h||h({ReactiveElement:m}),(null!==(n=globalThis.reactiveElementVersions)&&void 0!==n?n:globalThis.reactiveElementVersions=[]).push("1.3.0");const v=globalThis.trustedTypes,g=v?v.createPolicy("lit-html",{createHTML:e=>e}):void 0,b=`lit$${(Math.random()+"").slice(9)}$`,w="?"+b,y=`<${w}>`,x=document,C=(e="")=>x.createComment(e),$=e=>null===e||"object"!=typeof e&&"function"!=typeof e,k=Array.isArray,L=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_=/-->/g,M=/>/g,z=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,S=/'/g,A=/"/g,H=/^(?:script|style|textarea|title)$/i,N=(e=>(i,...t)=>({_$litType$:e,strings:i,values:t}))(1),j=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),P=new WeakMap,F=x.createTreeWalker(x,129,null,!1),T=(e,i)=>{const t=e.length-1,s=[];let r,o=2===i?"<svg>":"",a=L;for(let i=0;i<t;i++){const t=e[i];let n,l,d=-1,h=0;for(;h<t.length&&(a.lastIndex=h,l=a.exec(t),null!==l);)h=a.lastIndex,a===L?"!--"===l[1]?a=_:void 0!==l[1]?a=M:void 0!==l[2]?(H.test(l[2])&&(r=RegExp("</"+l[2],"g")),a=z):void 0!==l[3]&&(a=z):a===z?">"===l[0]?(a=null!=r?r:L,d=-1):void 0===l[1]?d=-2:(d=a.lastIndex-l[2].length,n=l[1],a=void 0===l[3]?z:'"'===l[3]?A:S):a===A||a===S?a=z:a===_||a===M?a=L:(a=z,r=void 0);const c=a===z&&e[i+1].startsWith("/>")?" ":"";o+=a===L?t+y:d>=0?(s.push(n),t.slice(0,d)+"$lit$"+t.slice(d)+b+c):t+b+(-2===d?(s.push(void 0),i):c)}const n=o+(e[t]||"<?>")+(2===i?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==g?g.createHTML(n):n,s]};class R{constructor({strings:e,_$litType$:i},t){let s;this.parts=[];let r=0,o=0;const a=e.length-1,n=this.parts,[l,d]=T(e,i);if(this.el=R.createElement(l,t),F.currentNode=this.el.content,2===i){const e=this.el.content,i=e.firstChild;i.remove(),e.append(...i.childNodes)}for(;null!==(s=F.nextNode())&&n.length<a;){if(1===s.nodeType){if(s.hasAttributes()){const e=[];for(const i of s.getAttributeNames())if(i.endsWith("$lit$")||i.startsWith(b)){const t=d[o++];if(e.push(i),void 0!==t){const e=s.getAttribute(t.toLowerCase()+"$lit$").split(b),i=/([.?@])?(.*)/.exec(t);n.push({type:1,index:r,name:i[2],strings:e,ctor:"."===i[1]?q:"?"===i[1]?I:"@"===i[1]?U:Z})}else n.push({type:6,index:r})}for(const i of e)s.removeAttribute(i)}if(H.test(s.tagName)){const e=s.textContent.split(b),i=e.length-1;if(i>0){s.textContent=v?v.emptyScript:"";for(let t=0;t<i;t++)s.append(e[t],C()),F.nextNode(),n.push({type:2,index:++r});s.append(e[i],C())}}}else if(8===s.nodeType)if(s.data===w)n.push({type:2,index:r});else{let e=-1;for(;-1!==(e=s.data.indexOf(b,e+1));)n.push({type:7,index:r}),e+=b.length-1}r++}}static createElement(e,i){const t=x.createElement("template");return t.innerHTML=e,t}}function O(e,i,t=e,s){var r,o,a,n;if(i===j)return i;let l=void 0!==s?null===(r=t._$Cl)||void 0===r?void 0:r[s]:t._$Cu;const d=$(i)?void 0:i._$litDirective$;return(null==l?void 0:l.constructor)!==d&&(null===(o=null==l?void 0:l._$AO)||void 0===o||o.call(l,!1),void 0===d?l=void 0:(l=new d(e),l._$AT(e,t,s)),void 0!==s?(null!==(a=(n=t)._$Cl)&&void 0!==a?a:n._$Cl=[])[s]=l:t._$Cu=l),void 0!==l&&(i=O(e,l._$AS(e,i.values),l,s)),i}class E{constructor(e,i){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var i;const{el:{content:t},parts:s}=this._$AD,r=(null!==(i=null==e?void 0:e.creationScope)&&void 0!==i?i:x).importNode(t,!0);F.currentNode=r;let o=F.nextNode(),a=0,n=0,l=s[0];for(;void 0!==l;){if(a===l.index){let i;2===l.type?i=new D(o,o.nextSibling,this,e):1===l.type?i=new l.ctor(o,l.name,l.strings,this,e):6===l.type&&(i=new Y(o,this,e)),this.v.push(i),l=s[++n]}a!==(null==l?void 0:l.index)&&(o=F.nextNode(),a++)}return r}m(e){let i=0;for(const t of this.v)void 0!==t&&(void 0!==t.strings?(t._$AI(e,t,i),i+=t.strings.length-2):t._$AI(e[i])),i++}}class D{constructor(e,i,t,s){var r;this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=t,this.options=s,this._$Cg=null===(r=null==s?void 0:s.isConnected)||void 0===r||r}get _$AU(){var e,i;return null!==(i=null===(e=this._$AM)||void 0===e?void 0:e._$AU)&&void 0!==i?i:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===e.nodeType&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=O(this,e,i),$(e)?e===V||null==e||""===e?(this._$AH!==V&&this._$AR(),this._$AH=V):e!==this._$AH&&e!==j&&this.$(e):void 0!==e._$litType$?this.T(e):void 0!==e.nodeType?this.k(e):(e=>{var i;return k(e)||"function"==typeof(null===(i=e)||void 0===i?void 0:i[Symbol.iterator])})(e)?this.S(e):this.$(e)}A(e,i=this._$AB){return this._$AA.parentNode.insertBefore(e,i)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.A(e))}$(e){this._$AH!==V&&$(this._$AH)?this._$AA.nextSibling.data=e:this.k(x.createTextNode(e)),this._$AH=e}T(e){var i;const{values:t,_$litType$:s}=e,r="number"==typeof s?this._$AC(e):(void 0===s.el&&(s.el=R.createElement(s.h,this.options)),s);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===r)this._$AH.m(t);else{const e=new E(r,this),i=e.p(this.options);e.m(t),this.k(i),this._$AH=e}}_$AC(e){let i=P.get(e.strings);return void 0===i&&P.set(e.strings,i=new R(e)),i}S(e){k(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let t,s=0;for(const r of e)s===i.length?i.push(t=new D(this.A(C()),this.A(C()),this,this.options)):t=i[s],t._$AI(r),s++;s<i.length&&(this._$AR(t&&t._$AB.nextSibling,s),i.length=s)}_$AR(e=this._$AA.nextSibling,i){var t;for(null===(t=this._$AP)||void 0===t||t.call(this,!1,!0,i);e&&e!==this._$AB;){const i=e.nextSibling;e.remove(),e=i}}setConnected(e){var i;void 0===this._$AM&&(this._$Cg=e,null===(i=this._$AP)||void 0===i||i.call(this,e))}}class Z{constructor(e,i,t,s,r){this.type=1,this._$AH=V,this._$AN=void 0,this.element=e,this.name=i,this._$AM=s,this.options=r,t.length>2||""!==t[0]||""!==t[1]?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=V}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,i=this,t,s){const r=this.strings;let o=!1;if(void 0===r)e=O(this,e,i,0),o=!$(e)||e!==this._$AH&&e!==j,o&&(this._$AH=e);else{const s=e;let a,n;for(e=r[0],a=0;a<r.length-1;a++)n=O(this,s[t+a],i,a),n===j&&(n=this._$AH[a]),o||(o=!$(n)||n!==this._$AH[a]),n===V?e=V:e!==V&&(e+=(null!=n?n:"")+r[a+1]),this._$AH[a]=n}o&&!s&&this.C(e)}C(e){e===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=e?e:"")}}class q extends Z{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===V?void 0:e}}const B=v?v.emptyScript:"";class I extends Z{constructor(){super(...arguments),this.type=4}C(e){e&&e!==V?this.element.setAttribute(this.name,B):this.element.removeAttribute(this.name)}}class U extends Z{constructor(e,i,t,s,r){super(e,i,t,s,r),this.type=5}_$AI(e,i=this){var t;if((e=null!==(t=O(this,e,i,0))&&void 0!==t?t:V)===j)return;const s=this._$AH,r=e===V&&s!==V||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,o=e!==V&&(s===V||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var i,t;"function"==typeof this._$AH?this._$AH.call(null!==(t=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==t?t:this.element,e):this._$AH.handleEvent(e)}}class Y{constructor(e,i,t){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(e){O(this,e)}}const K=window.litHtmlPolyfillSupport;
/**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
